...
// เช็คว่า session ของผู้ใช้มีข้อมูลหรือไม่ (เช่น user_id)
if (!isset($_SESSION['user_id'])) {
    // ถ้าไม่มี session หรือไม่ล็อกอิน, ส่งผู้ใช้ไปหน้า login
...
<body class="bg-gray-100 flex justify-center items-center min-h-screen">
    ...
    <div class="relative content-box text-center z-10">
        ...
        <?php if (isset($_SESSION['user_id'])): ?>
            <a href="logout.p" class="mt-6 block bg-red-500 text-white py-2 px-4 rounded-lg hover:bg-red-600">
                ออกจากระบบ
            </a>
        <?php endif; ?>
